...
class FundUtilizationTracker:
    ...
    remaining amount, and flags non-accusatory administrative audit alerts.
    """
    def __init__(self):
        pass
    ...
    def process_fund_utilization(
        ...
        DEFAULT_ALLOCATION = 50000000.0  # ₹ 5.0 Crores fallback
        ...
        def assign_alert(util_pct):
            if util_pct > 100.0:
                return "POTENTIAL ALLOCATION RECONCILIATION REQUIRED"
            elif util_pct >= 90.0:
